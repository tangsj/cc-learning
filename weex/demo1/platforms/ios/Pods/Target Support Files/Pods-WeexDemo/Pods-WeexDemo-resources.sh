...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/WeexSDK/WeexSDK.framework/native-bundle-main.js"
  install_resource "${PODS_ROOT}/WeexSDK/WeexSDK.framework/wx_load_error@3x.png"
  install_resource "${PODS_ROOT}/../Weexplugin/Weexplugin/Resources/WeexpluginConfig.xml"
fi
